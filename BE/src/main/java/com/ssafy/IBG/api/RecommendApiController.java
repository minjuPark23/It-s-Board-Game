...
public class RecommendApiController {
     ...
     * */
    @GetMapping("/user/survey/{userNo}")
    public Result getSurveyGameList(@PathVariable Integer userNo){
    ...
    public Result getRecommendByReviews(@PathVariable(required = false) Integer userNo){
    ...
    public Result getRecommendByRanking(@PathVariable(required = false) Integer userNo){
    ...
    public Result getRecommendByScore(@PathVariable Integer userNo) throws JsonProcessingException {
        System.out.println("========================= : " + userNo);

        List<RecommendTestResponse> list = restapiService.requestGETAPI("/user", userNo);
    ...
    public Result getRecommendByCategory(@PathVariable Integer userNo){
